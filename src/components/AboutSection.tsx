...
import { Brain, MessageSquare, LinkIcon, Bot, Target, Eye, Heart } from "lucide-react";
...
const AboutSection = () => {
  ...
  return (
    <div id="sobre" className="scroll-mt-20">
      ...
      <section className="section-padding">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-talka mx-auto rounded-full mb-6"></div>
      ...
      {/* Poder dos Agentes - Reduzido para 4 cards principais */}
      <section className="section-padding bg-gradient-subtle">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="group">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 h-full hover:shadow-glow transition-all duration-300">
                ...
                <p className="text-sm text-muted-foreground">Diálogos naturais com compreensão de contexto</p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 h-full hover:shadow-glow transition-all duration-300">
                <div className="p-3 bg-gradient-talka rounded-xl mb-4 w-fit">
                  <LinkIcon className="h-7 w-7 text-foreground" />
                </div>
                <h4 className="text-lg font-semibold text-foreground mb-2">Integrações</h4>
                <p className="text-sm text-muted-foreground">Conectamos seus sistemas em um ecossistema único</p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 h-full hover:shadow-glow transition-all duration-300">
                ...
                <h4 className="text-lg font-semibold text-foreground mb-2">Deploy Rápido</h4>
                <p className="text-sm text-muted-foreground">Implementação ágil em semanas, não meses</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Missão, Visão, Valores - Mais Compacto */}
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 h-full hover:shadow-glow transition-all duration-300">
                <div className="p-3 bg-gradient-talka rounded-2xl mx-auto w-fit mb-4">
