        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/o-que-fazemos" className="text-gray-600 hover:text-purple-600 transition-colors">
                  O que Fazemos
                </Link>
              </li>
              <li>
                <Link to="/solucoes" className="text-gray-600 hover:text-purple-600 transition-colors">
                  Nossas Soluções
                </Link>
              </li>
              <li>
                <Link to="/insights" className="text-gray-600 hover:text-purple-600 transition-colors">
                  Insights
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 hover:text-green-500 transition-colors flex items-center gap-2"
                >
