  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-foreground dark:text-white max-w-4xl">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-purple-200 dark:bg-purple-800 border border-purple-300 dark:border-purple-700 p-2" />
              </div>
