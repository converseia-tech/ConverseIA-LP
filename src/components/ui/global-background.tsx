...
export const GlobalBackground = () => {
    ...
    // Create dynamic background gradients that follow mouse
    const background1 = useMotionTemplate`radial-gradient(circle at ${springX}px ${springY}px, rgba(168, 85, 247, 0.15), transparent 40%)`;
    const background2 = useMotionTemplate`radial-gradient(circle at ${springX}px ${springY}px, rgba(99, 102, 241, 0.15), transparent 40%)`;
