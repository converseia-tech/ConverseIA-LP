...
function Scene() {
  ...
  const getThemeColors = () => {
    switch (theme) {
      case 'dark':
        return {
          dotColor: '#B794F4', // Roxo claro para os pontos
          bgColor: '#0F0A1E',  // Roxo muito escuro de fundo
          dotOpacity: 0.08     // Aumentado para ser mais visível
        }
      case 'light':
        return {
          dotColor: '#8B5CF6', // Roxo médio
          bgColor: '#F9FAFB',  // Branco gelo
          dotOpacity: 0.12     // Opacidade moderada
        }
      default:
        return {
          dotColor: '#B794F4',
