...
// Navigation items for Header component
export const NAVIGATION_ITEMS = [
  { href: '/', label: 'Home' },
  { href: '/agentes-ia', label: 'Agentes IA' },
  { href: '/conciarge', label: 'Conciarge' },
  { href: '/direito', label: 'Direito' },
  { href: '/documentacao', label: 'Documentação' },
  { href: '/parcerias', label: 'Parcerias' },
  { href: '/contato', label: 'Contato' },
];

// Social links for Footer component
export const SOCIAL_LINKS = [
  { href: LINK_FOR_LINKEDIN, icon: 'linkedin', label: 'LinkedIn' },
  { href: LINK_FOR_INSTAGRAM, icon: 'instagram', label: 'Instagram' },
];
