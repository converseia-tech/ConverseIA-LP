        ...
        <section className="section-padding">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <div className="w-16 sm:w-24 h-1 bg-gradient-talka mx-auto rounded-full mb-8"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <div className="group">
                <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 sm:p-8 h-full hover:shadow-glow transition-all duration-500">
                  <div className="p-3 sm:p-4 bg-gradient-talka rounded-xl mb-4 sm:mb-6 w-fit">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center group">
                <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 sm:p-8 h-full hover:shadow-glow transition-all duration-500">
                  <div className="p-3 sm:p-4 bg-gradient-talka rounded-2xl mx-auto w-fit mb-4">
